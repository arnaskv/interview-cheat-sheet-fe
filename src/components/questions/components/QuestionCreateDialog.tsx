                ...
                {({ values, handleChange, handleBlur, errors, touched, isSubmitting }) => (
                    <Form>
                        <DialogContent>
                            ...
                            <Grid item xs={6} className={style.TextTitle}>Question</Grid>
                                <Grid item xs={12}>
                                    <TextField
                                        fullWidth
                                        multiline
                        ...
                        <DialogActions>
                            <Button onClick={() => setOpen(false)} className={style.CancleButton}>Cancel</Button>
                            <Button type="submit" disabled={isSubmitting} className={style.SubmitButton}>Add Question</Button>
                        </DialogActions>
                    </Form>
                )}
            </Formik>
